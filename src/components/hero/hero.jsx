      ...
      <div className="parent_hero">
        ...
        <div className=" tag-hero-mobile">
          ...
          <div className="tag">
            ...
            Foundation Day of CGU CODING CLUB
          </div>
          <img
            src="/images/cgu.jpg"
            alt="srm logo"
        ...
        <section className="column">
          <div className="left_side">
            ...
            <div className="title1">
              <span className="hackathon"> {"CGU - CODING  CLUB"}</span>
              <br />
              {/* <p className="tag1"> Coding Club Of CGU Odisha</p> */}
              {/* <span className="hackathon">Hackathon</span> */}
              <p className="description">
                National <span> Level Up Through CGU Cgu Coding Club</span>
          ...
          <div className="right_side">
            ...
            >
              ...
              <div className="flex flex-col ">
                ...
                {/* <p className="text-white  text-[0.8vw] ">
                  National Highway 16, Tamando, Bada Mahura, Janla, Bhubaneswer - 752054
                </p> */}
            ...
            <div className="col6 animated-div">
              ...
              <div className="flex items-start justify-between flex-col">
                <p className="text14">CGU CODING CLUB MEMBERS</p>
                <p className="text15">CGU STUDENS </p>
