...
const Navbar = () => {
  const handleInsta = () => {
    ...
    window.open("https://www.instagram.com/codingclubcgu");
    window.open("https://www.instagram.com/codingclubcgu");
  };
  const handleFb = () => {
    ReactGA.event({
  ...
  const handleRegisterClick = () => {
    ...
    window.open("https://track-dsa.netlify.app/");
  };
        ...
        <div className="components">
          ...
          <div className="last">
            <h2 className="register">
              <p onClick={handleRegisterClick}> DSA SHEET</p>
            </h2>
          </div>
        </div>
      </div>
          ...
          <div className="components-mobile">
            ...
            <div className="last-mobile">
              <h2 className="register-mobile">
                <a href="https://track-dsa.netlify.app/" target="_blank">
                DSA SHEET
                </a>
              </h2>
            </div>
