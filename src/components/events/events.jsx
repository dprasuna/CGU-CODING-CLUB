        ...
        <div className="events-container">
          ...
          <div className="section-content stage2-content">
            <div className="section-format">
              <h1>
                Abstract Submission
                <span className="stage2-reference" >
              ...
              <p>
                ...
                before the 28th of August 2024.
              </p>
            </div>
          </div>
          <div className="section-content stage3-content">
            <div className="section-format">
              ...
              <p>
                ...
                "CGU-CODING-CLUB" will be announced on the 30th of August 2023.
                <br /> <br />
          ...
          <div className="section-content stage4-content">
            <div className="section-format">
              ...
              <p>
                ...
                <br /> <br />
                ⏱️ The "CGU-CODING-CLUB" event will begin at 1:00 pm on the 8th of
                ...
                prize winners of the "CGU-CODING-CLUB" event on the 9th of September
                2023 by 4:00 pm.
              </p>
            </div>{" "}
          </div>
